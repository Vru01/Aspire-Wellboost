    ...
    <footer className="relative bg-gray-950 text-gray-400 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-serif text-xl font-bold">
                  <span style={{color: '#19e5e4'}}>Aspire</span>{' '}
                  <span style={{color: '#6fea6d'}}>Wellboost</span>
                </p>
                <p className="text-[9px] tracking-[0.22em] uppercase text-gray-600">Natural wellness made simple</p>
              </div>
            </div>
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4">
              ...
              <ContactItem
                ...
                color="text-cyan-500"
                href="mailto:aspirewellboost@gmail.com"
              >
                aspirewellboost@gmail.com
              </ContactItem>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600">
          <p>&copy; {currentYear} Aspire Wellboost. All rights reserved.</p>
